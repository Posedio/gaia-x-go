...
func TestCompliantParticipant(t *testing.T) {
	...
	connector, err := compliance.NewComplianceConnector(compliance.DevelopmentBranch, compliance.ArubaV1Notary, "loire", privateKey, "did:web:vc.mivp.group", "did:web:vc.mivp.group#X509-JWK2020")
	if err != nil {
		t.Fatal(err)
	}
